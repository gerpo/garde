<template>
    <div class="flex flex-no-wrap min-h-full from-gray-200 bg-gradient-to-br to-red-100">
        <!-- Sidebar starts -->
        ...
        <div
            ...
            :class="{
                ...
                '-right-0 sm:right-auto order-2': (settings.menuSide === MenuSide.RIGHT),
            }"
            ref="menu"
        >
            <div
                class="absolute flex items-center justify-center w-12 h-12 text-gray-300 duration-150 ease-in-out bg-gray-800 sm:hidden"
                :class="{ '-right-12': (settings.menuSide === MenuSide.LEFT), '-translate-x-12': menuVisible && (settings.menuSide === MenuSide.LEFT), '-left-12  rounded-l': (settings.menuSide === MenuSide.RIGHT), 'translate-x-72': menuVisible && (settings.menuSide === MenuSide.RIGHT) }"
            >
                <button @click="toggleMenu">
                    <menu-icon class="w-8 h-8 fill-current" />
                </button>
            </div>
            <div class="px-8">
